...
1. If the same server exists in both locations, the agent configuration is used
1. Global servers provide defaults available to all agents
...
- [Tools Guide](https://docs.useholodeck.ai/guides/tools/index.md) - Learn about MCP tool configuration in detail
- [Global Configuration Guide](https://docs.useholodeck.ai/guides/global-config/index.md) - Understand global vs agent configuration
- [Agent Configuration Guide](https://docs.useholodeck.ai/guides/agent-configuration/index.md) - Complete agent setup reference
