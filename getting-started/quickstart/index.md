...
Complete the [Installation Guide](https://docs.useholodeck.ai/getting-started/installation/index.md) before continuing.
...
For detailed MCP CLI usage, see the [MCP CLI Guide](https://docs.useholodeck.ai/guides/mcp-cli/index.md).
...
**Monitor Token Usage** All chat modes track cumulative token usage across the conversation. This helps you:
...
For installation issues, see the [Installation Guide](https://docs.useholodeck.ai/getting-started/installation/#troubleshooting).
...
- [Agent Configuration Reference](https://docs.useholodeck.ai/guides/agent-configuration/index.md)
- [Explore Tool Types](https://docs.useholodeck.ai/guides/tools/index.md)
- [Learn About Evaluations](https://docs.useholodeck.ai/guides/evaluations/index.md)
- [Browse Examples](https://docs.useholodeck.ai/examples/index.md)
- [Global Configuration Guide](https://docs.useholodeck.ai/guides/global-config/index.md)
...
- **Full docs**: <https://docs.useholodeck.ai>
